...
BOARD_WIDTH = BOARD_HEIGHT = 520#Kích thước của của bàn cờ
MOVE_LOG_PANEL_WIDTH = 320#Hiển thị kích thước của bảng lịch sử di chuyển
...
def main():
    ...
    move_log_font = p.font.SysFont("Arial", 16, False, False)#khởi tạo 1 font chữ để hiện thị thông tin lịch sử nước đi
    ...
    while running:
        ...
        for e in p.event.get():
            ...
            # nếu event là bàn phím
                ...
                if e.key == p.K_u:  # hoàn tác nước đi nếu nhấn u
                    game_state.undoMove()
                    move_made = True
                    animate = False
                    game_over = False
